...
import { useCompanySettings, useUploadCompanyLogo } from "@/hooks/use-settings";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        <div className="lg:col-span-2">
          <Card className="border-none shadow-xl rounded-3xl overflow-hidden bg-white">
            <CardHeader className="bg-muted/30 pb-8 pt-8 px-8 border-b border-muted/20">
              <CardTitle className="text-3xl font-serif">Official Profile</CardTitle>
              <CardDescription className="text-base text-muted-foreground/80 font-medium">
                Legal and statutory identifiers for LeadTap Digi Solutions.
              </CardDescription>
            </CardHeader>
        ...
        <div className="space-y-8">
          <Card className="border-none shadow-xl rounded-3xl overflow-hidden bg-zinc-900 text-white">
            ...
            <CardContent className="space-y-8">
              <div className="flex flex-col items-center gap-6">
                <div className="h-40 w-40 bg-zinc-800 rounded-3xl flex items-center justify-center overflow-hidden border-2 border-zinc-700 shadow-inner">
                  {logoUrl ? (
                ...
                <Button 
                  ...
                  variant="outline" 
                  className="w-full h-14 rounded-2xl border-zinc-700 bg-transparent hover:bg-zinc-800 transition-all font-bold uppercase tracking-widest text-[10px]"
          ...
          <Card className="border-none shadow-xl rounded-3xl overflow-hidden bg-white">
            ...
            <CardContent>
               <div className="p-8 border-2 border-dashed border-muted rounded-3xl flex flex-col items-center text-center gap-4">
                  ...
                  <Button variant="ghost" size="sm" className="text-primary font-bold uppercase tracking-widest text-[9px]">Upload template</Button>
               </div>
            </CardContent>
          </Card>
        </div>
